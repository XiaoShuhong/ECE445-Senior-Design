...
\textsc{\Large Design Document }\\[0.5cm] % Minor heading
%---------------------------------------------------------------------------------
%	TITLE SECTION
%---------------------------------------------------------------------------------

\HRule \\[0.5cm]
\huge \textbf{	InWhat: An Intelligent System for Wardrobe Design Document for ECE 445} % Title
\HRule \\[2cm]
...
\begin{minipage}{0.5\textwidth}
    \begin{center} \large
        ...
        \textsc{Bo Pan}\\ (bopan3@illinois.edu) \\  % Names and netID
...
\input{sections/cost and schedule.tex} % Copy the above 3 lines to add another section
